...
// StartNsqConsumer 启动nsq消费者，以后所有的消费者在这里注册
func StartNsqConsumer() {
	NsqConsumer(conf.ConnectTCPListenAddress+".message", "1", HandleMessage, 20)
	NsqConsumer(conf.ConnectTCPListenAddress+".message_send_ack", "1", HandleMessageSendACK, 20)
}
